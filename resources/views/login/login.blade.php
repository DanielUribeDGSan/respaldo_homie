<x-layout-web>
    <x-slot name="meta">
        ...
        <meta content="Ingresa con tu correo y contraseña" name="description" />
        <meta name="robots" content="noindex, follow" />

        <meta content="Iniciar sesión" property="og:title" />
        <meta content="Ingresa con tu correo y contraseña" property="og:description" />
        <meta property="og:type" content="website" />
        <meta property="og:locale" content="es_ES" />
        <meta property="og:url" content="https://www.respaldohomie.mx/iniciar-sesion" />
        <meta property="og:site_name" content="Iniciar sesión" />
        <meta content="Iniciar sesión" property="twitter:title" />
        <meta content="Ingresa con tu correo y contraseña" property="twitter:description" />
        ...
        <link rel="canonical" href="https://www.respaldohomie.mx/iniciar-sesion" />
            ...
            <div class="col-lg-8">
                <div class="container">
                    <div class="p-3">
                        ...
                        @livewire('iniciar-sesion',['key'=>$key])
                    </div>
                </div>
            </div>
        </div>
