<div x-data class="mt-3">
    <form onsubmit="return registrarForm(event)">
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-6 col-12 mt-2">
                ...
                <select class="form-input" id="type" wire:model.defer="createForm.type" onchange="typeUser()">
            ...
            <div class="col-lg-6 col-md-6 col-12 mt-2 d-none inmobiliaria">
                <label for="inmobiliaria" class="col-form-label fw-100 mt-2">Nombre de la inmobiliaria</label>
                <input type="text" class="form-input" id="inmobiliaria" onkeyup="onlyLetrasNum(this)"
                    maxlength="255" wire:model.defer="createForm.inmobiliaria" autocomplete="off">
                @if ($errors->has('createForm.inmobiliaria'))
                    <span>{{ $errors->first('createForm.inmobiliaria') }}</span>
                @endif
            </div>
    ...
    <script>
        ...
        const typeUser = () => {
            const type_user = document.querySelector('#type').value;
            if (type_user == 'broker') {
                document.querySelector('.inmobiliaria').classList.remove('d-none');
            } else {
                document.querySelector('.inmobiliaria').classList.add('d-none');
                document.querySelector('#inmobiliaria').value = "";
            }
