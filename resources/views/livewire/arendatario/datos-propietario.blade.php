<div x-data class="mt-3">
    ...
    <script>
        ...
        $('#name').keyup(function(e) {
            ...
            const cookievalue = e;
            document.cookie = "inquilino_propietario_name=" + encodeURIComponent($('#name').val()) + "; expires=" +
                expiresdate
                .toUTCString();
        });
        $('#last_name').keyup(function(e) {
            ...
            const expiresdate = new Date(2068, 1, 02, 11, 20);
            const cookievalue = e;
            document.cookie = "inquilino_propietario_last_name=" + encodeURIComponent($('#last_name').val()) +
                "; expires=" +
                expiresdate
                .toUTCString();
        });
        $('#email').keyup(function(e) {
            ...
            const expiresdate = new Date(2068, 1, 02, 11, 20);
            const cookievalue = e;
            document.cookie = "inquilino_propietario_email=" + encodeURIComponent($('#email').val()) +
                "; expires=" +
                expiresdate
                .toUTCString();
        });
        $('#phone').keyup(function(e) {
            ...
            const expiresdate = new Date(2068, 1, 02, 11, 20);
            const cookievalue = e;
            document.cookie = "inquilino_propietario_phone=" + encodeURIComponent($('#phone').val()) +
                "; expires=" +
                expiresdate
                .toUTCString();
        });
        ...
        $('#name2').keyup(function(e) {
            ...
            const expiresdate = new Date(2068, 1, 02, 11, 20);
            const cookievalue = e;
            document.cookie = "inquilino_broker_name=" + encodeURIComponent($('#name2').val()) + "; expires=" +
                expiresdate
                .toUTCString();
        });
        $('#last_name2').keyup(function(e) {
            ...
            const expiresdate = new Date(2068, 1, 02, 11, 20);
            const cookievalue = e;
            document.cookie = "inquilino_broker_last_name=" + encodeURIComponent($('#last_name2').val()) +
                "; expires=" +
                expiresdate
                .toUTCString();
        });
        $('#email2').keyup(function(e) {
            ...
            const expiresdate = new Date(2068, 1, 02, 11, 20);
            const cookievalue = e;
            document.cookie = "inquilino_broker_email=" + encodeURIComponent($('#email2').val()) + "; expires=" +
                expiresdate
                .toUTCString();
        });
        $('#phone2').keyup(function(e) {
            ...
            const expiresdate = new Date(2068, 1, 02, 11, 20);
            const cookievalue = e;
            document.cookie = "inquilino_broker_phone=" + encodeURIComponent($('#phone2').val()) + "; expires=" +
                expiresdate
                .toUTCString();
        });
    </script>
    <script>
        const registrarFormInquilinoAPropietario = (e) => {
            ...
            document.cookie = "inquilino_broker_name=; max-age=0";
            document.cookie = "inquilino_broker_last_name=; max-age=0";
            document.cookie = "inquilino_broker_email=; max-age=0";
            document.cookie = "inquilino_broker_phone=; max-age=0";
            document.cookie = "inquilino_propietario_name=; max-age=0";
            document.cookie = "inquilino_propietario_last_name=; max-age=0";
            document.cookie = "inquilino_propietario_email=; max-age=0";
            document.cookie = "inquilino_propietario_phone=; max-age=0";
