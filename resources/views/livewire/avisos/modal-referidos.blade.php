<div x-data>
    ...
    <div class="modal fade" id="modalReferidos" tabindex="-1" aria-labelledby="modalReferidosLabel"
                    ...
                    <div class="container">
                        <div class="d-flex align-items-center justify-content-center">
                            <svg width="141" height="78" viewBox="0 0 141 78" fill="none"
                                ...
                                <path d="M140.13 1H1V63.97H140.13V1Z" fill="white" stroke="#444545" stroke-width="0.76"
                                    stroke-miterlimit="10" stroke-linecap="round" />
                                <path d="M23.9502 63.4805V76.1305L34.3401 63.4805" fill="white" />
                                <path d="M23.9502 63.4805V76.1305L34.3401 63.4805" stroke="#444545" stroke-width="0.76"
                                    stroke-miterlimit="10" stroke-linecap="round" />
                                <path
                        ...
                        <p class="text-center mt-3">Has ingresado a Respaldo Homie como referido de
                            {{ $referido[0]->u_name }}
                            {{ $referido[0]->u_last_name }} , ahora sólo regístrate para empezar a utilizar tu
                            nueva
    ...
    @push('script')
        <script>
            const myModalReferidos = new bootstrap.Modal(document.getElementById("modalReferidos"), {});
            document.onreadystatechange = function() {
                myModalReferidos.show();
            };
        </script>
    @endpush
